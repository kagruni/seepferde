  ...
  return (
    <>
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-end">
        <Image src="/images/angebote/fuehrungskraefte-coaching.jpeg" alt="Pferdegestütztes Führungskräfte-Coaching auf dem Reiterhof" fill className="object-cover" priority />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollReveal delay={200}>
              <Image src="/images/angebote/fuehrungskraefte-coaching.jpeg" alt="Führungskraft beim Coaching mit Pferd" width={700} height={500} className="rounded-2xl w-full object-cover shadow-sm" />
            </ScrollReveal>
          </div>
        </div>
      </section>
